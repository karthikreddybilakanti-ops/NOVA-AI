export class AIService {
    async generateAnswer(sanitizedPrompt, modelId = 'nova-smart', history = [], attachment) {
    ...
    async generateContextualResponse(prompt, modelId, history, attachment) {
        const p = prompt.trim();
